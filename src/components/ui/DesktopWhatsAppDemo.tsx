...
import './DesktopWhatsAppDemo.css';
...
export const DesktopWhatsAppDemo: React.FC<DesktopWhatsAppDemoProps> = ({
  language,
  onClose,
  onContactClick
}) => {
  ...
  // Disable body scroll
  useEffect(() => {
    document.body.classList.add('dwd-modal-open');

    return () => {
      document.body.classList.remove('dwd-modal-open');
  ...
  return createPortal(
    <div className={`dwd-overlay ${isVisible ? 'dwd-visible' : ''} ${isClosing ? 'dwd-closing' : ''}`} onClick={handleClose}>
      <div
        className={`dwd-iphone-container ${isVisible ? 'dwd-visible' : ''} ${isClosing ? 'dwd-closing' : ''}`}
      ...
      >
        ...
        >
          {/* Side Buttons */}
          <div className="dwd-side-button dwd-silent-switch" />
          <div className="dwd-side-button dwd-volume-up" />
          <div className="dwd-side-button dwd-volume-down" />
          <div className="dwd-side-button dwd-power-button" />

          <div className="dwd-iphone-screen">
            {/* Wallpaper */}
            ...
            {/* Status Bar */}
            <div className="dwd-status-bar">
              <div className="dwd-status-left">
                <span>{currentTime}</span>
              </div>
              <div className="dwd-status-right">
                <div className="dwd-signal-bars">
                  <span /><span /><span /><span />
                </div>
                <span className="dwd-5g">5G</span>
                <div className="dwd-battery">
                  <div className="dwd-battery-body">
                    <div className="dwd-battery-level" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={`dwd-home-screen ${isWhatsAppOpen ? 'dwd-hidden' : ''}`}>
              ...
              <div className="dwd-time-widget">
                ...
                <div className="dwd-date">{currentDate}</div>
              </div>

              {/* Widgets */}
              <div className="dwd-widgets-container">
                <div className="dwd-widget dwd-widget-hover">
                  <div className="dwd-widget-header">
                    <div className="dwd-widget-icon dwd-weather-icon">
                      <img src={sunIcon} alt="Weather" className="dwd-widget-icon-img" />
                    </div>
                    <span>{t.weather}</span>
                  </div>
                ...
                <div className="dwd-widget dwd-widget-hover">
                  ...
                  <div className="dwd-music-playing">
                    <div className="dwd-music-album">
              ...
              {/* Dock */}
              <div className="dwd-dock">
                <div className="dwd-dock-icon dwd-close-icon dwd-dock-hover" onClick={handleClose}>
            ...
            {/* WhatsApp App */}
            <div className={`dwd-whatsapp-app ${isWhatsAppOpen ? 'dwd-active' : ''}`}>
              {/* Scenario Screen */}
              {showScenarioScreen && (
                <div className="dwd-scenario-screen">
                  <div className="dwd-scenario-header">
                    <div className="dwd-logo">
                    ...
                    <button className="dwd-close-btn" onClick={closeWhatsApp}>✕</button>
                  </div>

                  <div className="dwd-scenario-list">
              ...
              {/* Chat Screen */}
              {!showScenarioScreen && (
                <div className="dwd-chat-screen">
                  <div className="dwd-chat-header">
                    <button className="dwd-back-btn" onClick={goBack}>
                      <img src={backwardIcon} alt="Back" className="dwd-back-img" />
                    </button>
                    <div className="dwd-profile">
                      <img src={demoLogo} alt="Allync AI" />
                    </div>
                    <div className="dwd-info">
                      <h3>Allync AI</h3>
                      <p className={isTyping ? 'dwd-typing' : ''}>
                        {isTyping ? t.typing : t.online}
                      </p>
                    </div>
                    <div className="dwd-actions">
                      <button className="dwd-action-btn">
                        <img src={videoCallIcon} alt="Video" className="dwd-action-icon" />
                      </button>
                      <button className="dwd-action-btn">
                        <img src={callOutlineIcon} alt="Call" className="dwd-action-icon dwd-call-action-icon" />
                      </button>
                      <button className="dwd-action-btn" onClick={closeWhatsApp}>✕</button>
                    </div>
                  </div>

                  <div className="dwd-chat-area" ref={chatAreaRef}>
                    ...
                    {isTyping && (
                      <div className="dwd-typing-indicator">
                        <span /><span /><span />
                      </div>
                    )}

                    {demoCompleted && (
                      <div className="dwd-demo-actions">
                        <button className="dwd-restart-btn" onClick={restartDemo}>
                          🔄 {t.restart}
                        </button>
                        <button className="dwd-contact-btn" onClick={closeWhatsApp}>
                          🏠 {t.backToHome}
                        </button>
                      </div>
                    )}
                  ...
                  <div className="dwd-input-area">
                    <img src={sendMessageBar} alt="Message input" className="dwd-input-bar-img" />
                  </div>
                </div>
              )}
            </div>
            ...
            {/* Home Indicator */}
            <div className="dwd-home-indicator" onClick={isWhatsAppOpen ? closeWhatsApp : handleClose} />

            {/* Screen Reflection */}
            <div className="dwd-screen-reflection" />
          </div>
        </div>

        {/* Click outside hint */}
        <div className="dwd-hint">
