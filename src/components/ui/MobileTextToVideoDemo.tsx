          ...
          <div className="mtv-iphone-screen">
            ...
            <div className={`mtv-home-screen ${isAppOpen ? 'mtv-hidden' : ''}`}>
              ...
              <div className="mtv-dock">
                ...
                <div className="mtv-dock-icon mtv-safari-icon" onClick={handleContactNavigation}>
                ...
                <div className="mtv-dock-icon mtv-video-icon" onClick={openApp}>
                  <span className="mtv-video-tooltip">{t.tooltip}</span>
