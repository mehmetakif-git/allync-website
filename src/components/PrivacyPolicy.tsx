      ...
      content: (
        <>
          ...
          <BulletList items={[
            ...
            'Google (Gemini): Üretken AI içerik üretimi için — kurumsal API şartları kapsamında, müşteri verisi model eğitiminde kullanılmaz',
      ...
      content: (
        <>
          ...
          <BulletList items={[
            ...
            'Google (Gemini): For generative AI content — under enterprise API terms, customer data is not used for model training',
